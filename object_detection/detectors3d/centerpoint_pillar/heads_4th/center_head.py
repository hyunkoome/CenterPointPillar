...
from general.loss_functions import loss_utils
# from pcdet.models.model_utils import model_nms_utils
from general.networks import nms_utils # as model_nms_utils
from object_detection.detectors3d.centerpoint_pillar import centernet_utils
from object_detection.detectors3d.centerpoint_pillar.heads_4th.center_separate_head import CenterSeparateHead
...
class CenterHead(torch.nn.Module):
    def __init__(self, model_cfg, input_channels, num_class, class_names, grid_size, point_cloud_range, voxel_size,
        ...
        norm_func = partial(torch.nn.BatchNorm2d, eps=self.model_cfg.get('BN_EPS', 1e-5),
        ...
        self.heads_list = torch.nn.ModuleList()
        ...
        for idx, pred_dict in enumerate(pred_dicts):
            ...
            for k, final_dict in enumerate(final_pred_dicts):
                ...
                if post_process_cfg.NMS_CONFIG.NMS_TYPE not in ['circle_nms', 'class_specific_nms']:
                    ...
                    selected, selected_scores = nms_utils.class_specific_nms(
                        box_scores=final_dict['pred_scores'], box_preds=final_dict['pred_boxes'],
